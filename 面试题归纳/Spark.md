...
## Hive on Spark和 Spark SQL的区别？

这二者都只是负责翻译，将sql翻译成分布式的可执行的spark程序，即SQL引擎不同但是计算都是由spark完成的



hive还是适合离线非实时数据的处理，spark sql 适合实时性要求或者速度要求较高的情况

> [总结：Hive，Hive on Spark和SparkSQL区别](<https://blog.csdn.net/MrLevo520/article/details/76696073>)